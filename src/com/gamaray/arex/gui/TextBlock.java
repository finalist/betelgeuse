...
public class TextBlock implements Drawable {
    ...
    public TextBlock(String txtInit, float fontSizeInit, float maxWidth, DrawWindow dw) {
        this(txtInit, fontSizeInit, maxWidth, Color.rgb(255, 255, 255), Color.rgb(0, 0, 0), Color.rgb(255, 255, 255),
                dw.getTextAscent() / 2, dw);
    }

    public TextBlock(String txtInit, float fontSizeInit, float maxWidth, int borderColor, int bgColor, int textColor,
            float pad, DrawWindow dw) {
        this.pad = pad;
